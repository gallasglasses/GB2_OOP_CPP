...
void Robot::Logic()
{
	...
	case eDirection::LEFT:
		if (pos.x - 1 < 0)
		{
			...
			throw OffTheField("Do you wanna make demons fly out of your nose?\n");
		}
		else
		{
			pos.x--;
	...
	case eDirection::RIGHT:
		if (pos.x + 1 > iN - 1)
		{
			pos.x = iN - 1;
			ptrArr[pos.y][pos.x] = robotError;
			throw OffTheField("I will not repeat your mistake!\n");
		}
		else 
		{
			pos.x++;
	...
	case eDirection::UP:
		if (pos.y - 1 < 0)
		{
			pos.y = 0;
			ptrArr[pos.y][pos.x] = robotError;
			throw OffTheField("The world beyond is unpredictable!\n");
		}
		else 
		{
			pos.y--;
	...
	case eDirection::DOWN:
		if (pos.y + 1 > iN - 1)
		{
			pos.y = iN - 1;
			ptrArr[pos.y][pos.x] = robotError;
			throw OffTheField("Why should I be made to pay for your undefined behavior?\n");
		}
		else
		{
			pos.y++;
...
void Robot::Input()
{
	...
	default:
	{
		...
		printField();
		throw IllegalCommand("What are you doing? I don't understand you!\n");
	}
		break;
	}
